...
const Contact = () => {
  return (
    <section className=' p-20'>
      <div className='bg-purple-300 rounded py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
        ...
        <form className='space-y-8'>
          ...
          <button
            type='submit'
            className='py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-purple-700 sm:w-fit hover:bg-black transition-all focus:ring-4 focus:outline-none focus:ring-purple-300'>
            Send message
          </button>
        </form>
      </div>
